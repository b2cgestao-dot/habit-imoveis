...
const Cabecalho = () => {
  ...
  return (
    <header ref={headerRef} className="fixed top-4 md:top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-5xl z-50 bg-slate-800/85 backdrop-blur-xl border border-white/10 rounded-md px-6 md:px-8 py-3 shadow-2xl flex items-center justify-between transition-all duration-300">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <a
          ...
          className="btn-vip-anim flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white px-6 py-2.5 rounded-md font-medium text-sm transition-all duration-300 shadow-[0_4px_15px_-5px_rgba(16,185,129,0.5)] hover:shadow-[0_8px_20px_-5px_rgba(16,185,129,0.6)] hover:-translate-y-0.5"
        >

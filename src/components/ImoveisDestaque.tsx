...
const ImoveisDestaque = () => {
  ...
  return (
    <section id="imoveis" className="py-24 md:py-32 bg-slate-900 text-white overflow-hidden">
          ...
          <div className="w-full lg:w-2/3">
            <div className={`grid gap-8 ${isMobile ? 'grid-cols-1' : 'md:grid-cols-2'}`}>
              {visibleImoveis.map((imovel, index) => (
                <div key={index} className="bg-slate-800/40 backdrop-blur-sm rounded-3xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.6)] transition-all duration-500 border border-white/5 flex flex-col group hover:-translate-y-1">
